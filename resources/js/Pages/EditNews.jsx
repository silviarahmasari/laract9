            ...
            <Navbar user={props.auth.user}/>
                <div className="m-2 card w-full lg:w-96 bg-base-100 shadow-xl">
                    ...
                    <div className="card-body">
                        ...
                        <input type="text" placeholder="Deskripsi" className="m-2 input input-bordered w-full" onChange={(desc) => setDescription(desc.target.value)} defaultValue={props.myNews.description} />
